...
for recipe in range(1, recipe_count + 1):
    db.execute("INSERT INTO recipes (title, created_at, user_id) VALUES (?, ?, ?)", ["recipe" + str(recipe), random.randint(1, 1000), random.randint(1, user_count)])
...
for i in range(1, review_count + 1):
    ...
    db.execute("INSERT INTO reviews (recipe_id, user_id, rating, comment, created_at) VALUES (?, ?, ?, ?, ?)", [recipe_id, random.randint(1, user_count), rating, "comment", random.randint(1, 1000)])
